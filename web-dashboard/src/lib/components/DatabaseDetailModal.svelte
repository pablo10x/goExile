...
{#if isOpen}
	...
	>
		<div class="flex items-center gap-4 mb-6 border-b-2 border-neutral-800 pb-4">
			<div class="p-2.5 bg-emerald-500/10 border border-emerald-500/30 rounded-none">
				<Database class="w-5 h-5 text-emerald-500" />
			</div>
			<div>
				<h3 class="font-heading font-black text-white uppercase tracking-widest text-sm italic">
					Persistence_Cores
				</h3>
				<div
					class="text-[9px] text-neutral-500 font-mono font-black flex items-center gap-2 uppercase tracking-tight"
				>
					<span
		...
		<div class="space-y-6">
			...
			<div class="grid grid-cols-2 gap-4">
				<div class="bg-black border border-neutral-800 p-4 shadow-inner">
					<div
						class="text-[8px] font-mono font-black text-neutral-600 mb-2 uppercase tracking-widest"
					>
						Active / Cap
					</div>
				...
				<div class="bg-black border border-neutral-800 p-4 shadow-inner">
					...
					<div class="text-xl font-heading font-black text-emerald-500 tracking-tighter">
						{stats.db_in_use}
						<span class="text-neutral-700 text-xs font-mono">/ {stats.db_idle}</span>
					</div>
				</div>
			</div>
			...
			>
				<div>
					<div
						class="text-[8px] font-mono font-black text-neutral-600 mb-1 uppercase tracking-widest"
					>
						Buffer_Latency
					</div>
