...
{#if isOpen}
	...
	>
		...
		>
			...
			<div class="absolute -top-20 -right-20 w-64 h-64 bg-emerald-500/10 rounded-full blur-[80px] pointer-events-none group-hover:bg-emerald-500/20 transition-all duration-700"></div>
			...
			<div class="p-6 space-y-6 relative z-10">
                ...
                <div class="space-y-2 group/select">
					<label class="text-xs font-bold text-blue-400 uppercase tracking-wider flex items-center gap-1.5">
					...
					<div class="relative">
						...
						<div class="absolute left-3.5 top-3.5 text-slate-500 group-focus-within/select:text-blue-500 transition-colors">
							<User class="w-4 h-4" />
						</div>
                        <!-- Custom Chevron -->
