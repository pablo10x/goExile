...
<div class="h-full flex flex-col bg-slate-900">
    ...
    <!-- Toolbar -->
    <div class="px-6 py-3 bg-slate-900/50 border-b border-slate-200 dark:border-slate-800 flex justify-between">
    ...
    <div class="flex-1 overflow-auto">
        ...
        {:else}
            <table class="w-full text-left text-sm border-collapse">
                <thead class="bg-white dark:bg-slate-950 text-slate-500 dark:text-slate-400 sticky top-0 shadow-sm z-10">
                    <tr>
                        <th class="px-6 py-3 border-b border-slate-200 dark:border-slate-800 w-1/3">Parameter</th>
