...
<div class="h-full flex flex-col bg-transparent">
	...
	>
		<div class="flex items-center gap-4">
			...
			<div>
				...
				>
					Tune database parameters (postgresql.conf)
				</p>
			</div>
		</div>
	...
	>
		...
		<div
			class="font-jetbrains text-[9px] font-bold text-amber-500/60 flex items-center gap-3 uppercase tracking-widest italic"
		>
			...
			<table class="w-full text-left font-jetbrains text-[11px] border-collapse">
				...
				<tbody class="divide-y divide-neutral-800/50">
					{#each filteredConfig as cfg}
						...
						>
							<td
								class="px-6 py-4 font-bold text-indigo-400/80 uppercase tracking-tighter border-r border-neutral-800/20 italic"
							>
								{cfg.name}
							</td>
							<td class="px-6 py-4 border-r border-neutral-800/20">
								<input
									...
									class="w-full bg-neutral-950/40 border {isModified
										? 'border-indigo-500'
										: 'border-neutral-800'} py-1.5 px-3 text-neutral-200 font-jetbrains text-[10px] focus:border-indigo-500 outline-none rounded-lg"
								/>
							</td>
							<td
								class="px-6 py-4 text-neutral-500 font-medium uppercase tracking-tight leading-relaxed text-[10px]"
							>
								{cfg.description}
							</td>
						</tr>
