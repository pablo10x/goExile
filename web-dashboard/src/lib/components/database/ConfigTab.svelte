...
<div class="h-full flex flex-col bg-[#050505]">
	...
	>
		<div class="flex items-center gap-4">
			...
			<div>
				...
				<p class="font-jetbrains text-[10px] text-stone-500 uppercase tracking-widest mt-1">Tune database parameters (postgresql.conf)</p>
			</div>
		</div>
	...
	<!-- Toolbar -->
	<div
		class="px-6 py-4 bg-[#0a0a0a]/50 border-b border-stone-800 flex justify-between items-center"
	>
		<div class="relative w-80">
			<Search class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-stone-600" />
			<input
				type="text"
				bind:value={filter}
		...
		<div class="font-jetbrains text-[9px] font-black text-amber-500/60 flex items-center gap-3 uppercase tracking-widest">
				...
				<tbody class="divide-y divide-stone-900">
					{#each filteredConfig as cfg}
						...
						>
							...
							<td class="px-6 py-4 text-stone-500 font-medium leading-relaxed">
								{cfg.description}
							</td>
						</tr>
					{/each}
