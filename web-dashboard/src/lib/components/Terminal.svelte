...
<div
	class="flex flex-col h-full bg-[#0d1117] rounded-lg border border-slate-800 overflow-hidden font-mono text-xs shadow-inner"
>
	<!-- Terminal Header -->
	<div
		class="px-4 py-2 bg-slate-900 border-b border-slate-800 flex justify-between items-center select-none"
	>
