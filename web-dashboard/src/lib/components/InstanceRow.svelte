...
<div class="border border-slate-700/50 rounded-lg bg-slate-800/30 overflow-hidden mb-2">
	...
	>
		...
		<div class="flex-1 grid grid-cols-12 gap-4 items-center">
			<div
				class="col-span-3 font-mono text-slate-300 truncate"
			...
			<div class="col-span-2">
				...
				{:else if instance.status === 'Provisioning'}
					<span
						class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20 animate-pulse"
					>
						Provisioning
					</span>
	...
	{#if expanded}
		<div
			...
			class="bg-slate-900/50 border-t border-slate-700/50 p-4"
		>
			<!-- Toolbar -->
...
<style lang="postcss">
	.btn-toolbar {
		@apply gap-2 px-3 py-1.5 rounded text-xs font-semibold flex items-center transition-all;
	}
</style>
