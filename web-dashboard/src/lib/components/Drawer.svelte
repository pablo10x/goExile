...
{#if isOpen}
	<div class="fixed inset-0 z-[150] flex justify-end">
		...
		<!-- Drawer Content -->
		<div
			class="relative w-full max-w-2xl bg-[#050505] border-l border-zinc-800 shadow-2xl h-full flex flex-col transform transition-transform duration-300 ease-out glass-panel industrial-sharp"
		...
		>
			...
			<!-- Header -->
			<div
				class="flex items-center justify-between px-8 py-6 border-b border-zinc-800 bg-black/40 relative z-20"
			>
