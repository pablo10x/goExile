<script lang="ts">
    ...
    function getColorClasses() {
        const baseClasses = 'relative overflow-hidden rounded-full transition-all duration-500 ease-out';
        const colorMap = {
...
<div class="space-y-2">
    ...
    <div class="{height} bg-slate-700/50 rounded-full overflow-hidden relative">
        ...
        <!-- Progress fill -->
        <div 
            class="{height} {getColorClasses()} relative"
        ...
        {#if showThreshold}
            <div 
                class="absolute top-0 h-full w-0.5 bg-red-500/80"
