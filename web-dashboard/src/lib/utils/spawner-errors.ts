...
export class SpawnerErrorWrapper {
  ...
  constructor(error: Partial<SpawnerError>) {
    this.error = {
      ...
      } as SpawnerError['context'] : undefined,
      cause: error.cause,
   ...
   */
  static network(code: string, message: string, details?: Record<string, any>, context?: SpawnerErrorContextInput): SpawnerErrorWrapper {
   ...
   */
  static validation(code: string, message: string, details?: Record<string, any>, context?: SpawnerErrorContextInput): SpawnerErrorWrapper {
    return new SpawnerErrorWrapper({
   ...
   */
  static permission(code: string, message: string, details?: Record<string, any>, context?: SpawnerErrorContextInput): SpawnerErrorWrapper {
    return new SpawnerErrorWrapper({
   ...
   */
  static resource(code: string, message: string, details?: Record<string, any>, context?: SpawnerErrorContextInput): SpawnerErrorWrapper {
    return new SpawnerErrorWrapper({
   ...
   */
  static config(code: string, message: string, details?: Record<string, any>, context?: SpawnerErrorContextInput): SpawnerErrorWrapper {
    return new SpawnerErrorWrapper({
   ...
   */
  static timeout(code: string, message: string, details?: Record<string, any>, context?: SpawnerErrorContextInput): SpawnerErrorWrapper {
    return new SpawnerErrorWrapper({
   ...
   */
  static wrap(error: Error, type: SpawnerErrorType = SpawnerErrorType.UNKNOWN, context?: SpawnerErrorContextInput): SpawnerErrorWrapper {
    return new SpawnerErrorWrapper({
      type,
      severity: ErrorSeverity.MEDIUM,
      code: 'WRAPPED_ERROR',
 ...
 */
export function handleUIError(error: unknown, context?: Partial<SpawnerError['context']>): SpawnerErrorWrapper {
  if (error instanceof SpawnerErrorWrapper) {
    return error;
  }
