...
<!-- Content without extra container - let layout handle the background -->
<div class="space-y-6">
	<div class="p-6">
		<!-- Page Content -->
		<div class="flex items-center justify-between mb-8">
			...
			<div class="flex gap-4">
				<div
					class="px-4 py-2 bg-slate-700/60 backdrop-blur border border-slate-600 rounded-lg flex items-center gap-3"
				>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
			...
			<div class="transform hover:scale-[1.02] transition-transform duration-300">
				<div
					class="bg-slate-800/60 backdrop-blur-sm border border-slate-700 rounded-xl overflow-hidden"
				>
