...
<body>
    ...
    <div class="content">
        <div class="demo-card">
            ...
            <p>Advanced 3D animated background with mountain range, floating particles, and spark effects from bottom right.</p>
        </div>
    </div>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js"></script>
    <script>
        let scene, camera, renderer, particles, geometries = [], sparks = [];
        ...
        function animate() {
            ...
            geometries.forEach((mesh, i) => {
                ...
                mesh.position.y += Math.sin(time * mesh.userData.floatSpeed + mesh.userData.floatOffset) * 0.04;
            });
