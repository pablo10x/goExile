...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-slate-100 mb-2">{categoryTitles[category] || 'Configuration'}</h1>
    ...
    {:else if categoryConfigs.length === 0}
        <div class="text-center py-12">
            ...
            <div class="text-slate-500 text-sm">This category may not have any configurable options yet.</div>
        </div>
    {:else}
