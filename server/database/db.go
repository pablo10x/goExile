...
func SeedDefaultConfig(db *sqlx.DB) error {
        defaultConfigs := []models.ServerConfig{
                ...
                },
                {
                        ...
                        Value:           `{"show_smoke":true,"show_rain":true,"show_clouds":true,"show_vignette":true,"show_navbar_particles":true,"rain_opacity":0.2,"clouds_opacity":0.3,"global_type":"architecture","settings":{"architecture":{"intensity":0.5,"speed":1,"density":1,"color":"#f97316"},"tactical_grid":{"intensity":0.5,"speed":1,"density":1,"color":"#f97316"},"neural_network":{"intensity":0.5,"speed":1,"density":1,"color":"#f97316"},"data_flow":{"intensity":0.5,"speed":1,"density":1,"color":"#f97316"},"digital_horizon":{"intensity":0.5,"speed":1,"density":1,"color":"#f97316"}}}`,
                        Type:            "json",
                        Category:        "aesthetic",
