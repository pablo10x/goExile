...
func TestWebSocketAuthentication(t *testing.T) {
	...
	authConfig := auth.AuthConfig{Enabled: true} // Minimal config
	sessionStore := auth.NewSessionStore(false)
	...
	protectedHandler := middleware.UnifiedAuthMiddleware(testAPIKey, authConfig, sessionStore)(wsHandler)
