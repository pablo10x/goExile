// Package errors defines custom error types and codes for the node.
package errors
...
// New creates a new NodeError with the given code and message
func New(code, message string) *NodeError {
	return &NodeError{
		Code:    code,
		Message: message,
		Stack:   captureStack(),
...
// Newf creates a new NodeError with formatted message
func Newf(code, format string, args ...any) *NodeError {
	return &NodeError{
		Code:    code,
...
func Wrap(err error, code, operation string) *NodeError {
	if err == nil {
		return nil
	}
	...
	// If the underlying error is already a NodeError, preserve its context
	if underlying, ok := err.(*NodeError); ok {
...
func Wrapf(err error, code, format string, args ...any) *NodeError {
	if err == nil {
		return nil
	}
...
func (e *NodeError) WithContextMap(ctx map[string]any) *NodeError {
	if e.Context == nil {
		e.Context = make(map[string]any)
	}
	for k, v := range ctx {
...
func (e *NodeError) LogAttrs() []slog.Attr {
	attrs := []slog.Attr{
...
func (e *NodeError) LogValue() slog.Value {
...
func ProcessStartError(operation string, cause error) *NodeError {
...
func ProcessStopError(operation string, cause error) *NodeError {
...
func PortAllocationError(minPort, maxPort int, cause error) *NodeError {
...
func FileOperationError(operation, path string, cause error) *NodeError {
...
func NetworkError(operation string, cause error) *NodeError {
	return Wrap(cause, ErrCodeNetwork, operation).
		WithContext("error_type", "network")
}

// ConfigError creates a configuration error
func ConfigError(field, value string, cause error) *NodeError {
...
func TimeoutError(operation string, timeout string, cause error) *NodeError {
...
func ValidationError(field, value string, cause error) *NodeError {
...
func PermissionError(operation, resource string, cause error) *NodeError {
...
func ResourceError(resourceType, resourceID string, cause error) *NodeError {
