// Package api provides HTTP handlers for the node's REST and WebSocket endpoints.
package api
...
// Handler manages the node API endpoints.
type Handler struct {
...
// HandleGetLogs handles the node log retrieval request.
...
// HandleClearLogs handles the node log clear request.
